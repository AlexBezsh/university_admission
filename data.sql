...
-- Database initialization backup. Move it to src/main/resources and Spring Boot will execute it.
-- Don't forget to place 'spring.datasource.initialization-mode=always' in application.properties
